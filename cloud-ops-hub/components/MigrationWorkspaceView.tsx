...
export const BOTECO_PROJECTS = [
  {
    ...
    repo: 'ViniScooper/MY_VM_ORACLE (branch main)',
  ...
  },
  {
    ...
    repo: 'ViniScooper/controle-financeiro (branch main)',
  ...
  },
  {
    ...
    tag: 'Multi-Stack Completo (Docker + PM2 + CloudOps Hub)',
    icon: '☁️',
    db: 'Todos os Bancos (Oracle ATP + boteco_db + schemas PM2 + Supabase)',
    dbName: 'bancodedadosfinancas, boteco_db, auth_db, supabase',
    dbSize: '~35 MB',
    storage: 'Todos os Buckets Cloud + Pastas /uploads',
    storageDetails: 'Backup integral da VM',
    backend: 'Todos os Containers Docker + Processos Node/PM2 + Nginx',
    backendDetails: 'Migração integral de ambiente',
    frontend: 'Todas as rotas e domínios DNS Cloudflare/Nginx/Vercel',
    repo: 'Ambiente completo',
    dockerContainers: ['financeiro_backend', 'financeiro_tunnel', 'boteco_backend', 'boteco_db', 'boteco_tunnel', 'nginx-manager-nginx-1', 'plataforma_ingles_api'],
    port: '3005, 3006, 3002, 3003, 3001',
    healthPath: '/'
  }
]
